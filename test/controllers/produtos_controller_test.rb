...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { grupo_produto_id: @produto.grupo_produto_id, nome: @produto.nome, unidade_id: @produto.unidade_id } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { grupo_produto_id: @produto.grupo_produto_id, nome: @produto.nome, unidade_id: @produto.unidade_id } }
