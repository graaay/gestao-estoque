...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { cidade: @cidade.cidade, estado_id: @cidade.estado_id } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { cidade: @cidade.cidade, estado_id: @cidade.estado_id } }
